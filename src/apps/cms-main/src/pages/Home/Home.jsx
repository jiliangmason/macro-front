...
export default function Home(props) {
  ...
  function initApps() {
     ...
     * Step3 设置默认进入的子应用
     */
    setDefaultMountApp("/cms-main/cms-react-template");
  ...
  return (
    <Main>
      <Content>
        ...
        <ASide>
          <RouteItem onClick={() => goApp("/cms-main/cms-react-template")}>
            react-template
          </RouteItem>
          <RouteItem onClick={() => goApp("/cms-main/cms-ts-template")}>
            ts-template
          </RouteItem>
        </ASide>
      </Content>
